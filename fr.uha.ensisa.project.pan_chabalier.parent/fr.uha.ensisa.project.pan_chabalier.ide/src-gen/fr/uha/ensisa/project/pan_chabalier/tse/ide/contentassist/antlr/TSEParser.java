		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTransitionAccess().getNameAssignment_0_1(), "rule__Transition__NameAssignment_0_1");
					put(grammarAccess.getTransitionAccess().getStartAssignment_0_2(), "rule__Transition__StartAssignment_0_2");
					put(grammarAccess.getTransitionAccess().getEndAssignment_0_4(), "rule__Transition__EndAssignment_0_4");
					put(grammarAccess.getTransitionAccess().getTransitionPropertiesAssignment_0_5(), "rule__Transition__TransitionPropertiesAssignment_0_5");
					put(grammarAccess.getTransitionAccess().getLabelAssignment_0_6(), "rule__Transition__LabelAssignment_0_6");
