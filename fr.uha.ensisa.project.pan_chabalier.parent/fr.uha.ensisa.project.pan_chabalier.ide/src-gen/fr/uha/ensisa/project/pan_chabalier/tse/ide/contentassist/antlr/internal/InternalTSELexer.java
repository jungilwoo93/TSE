...
public class InternalTSELexer extends Lexer {
    ...
    public final void mRULE_DEFAULT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1576:14: ( ( 'DEFAULT' | 'default' ) )
            // InternalTSE.g:1576:16: ( 'DEFAULT' | 'default' )
            {
            // InternalTSE.g:1576:16: ( 'DEFAULT' | 'default' )
            int alt1=2;
    ...
    public final void mRULE_COLOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1578:12: ( ( 'WHITE' | 'BLACK' | 'BLUE' | 'CYAN' | 'DARK_GRAY' | 'GRAY' | 'LIGHT_GRAY' | 'GREEN' | 'MAGENTA' | 'ORANGE' | 'PINK' | 'RED' | 'YELLOW' ) )
            // InternalTSE.g:1578:14: ( 'WHITE' | 'BLACK' | 'BLUE' | 'CYAN' | 'DARK_GRAY' | 'GRAY' | 'LIGHT_GRAY' | 'GREEN' | 'MAGENTA' | 'ORANGE' | 'PINK' | 'RED' | 'YELLOW' )
            {
            // InternalTSE.g:1578:14: ( 'WHITE' | 'BLACK' | 'BLUE' | 'CYAN' | 'DARK_GRAY' | 'GRAY' | 'LIGHT_GRAY' | 'GREEN' | 'MAGENTA' | 'ORANGE' | 'PINK' | 'RED' | 'YELLOW' )
            int alt2=13;
            ...
            switch (alt2) {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // InternalTSE.g:1578:45: 'DARK_GRAY'
                    {
                    match("DARK_GRAY"); 
                ...
                case 6 :
                    ...
                    break;
                case 7 :
                    // InternalTSE.g:1578:64: 'LIGHT_GRAY'
                    {
                    match("LIGHT_GRAY"); 
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1580:12: ( RULE_INT '.' RULE_INT )
            // InternalTSE.g:1580:14: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1582:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalTSE.g:1582:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalTSE.g:1582:11: ( '^' )?
            int alt3=2;
            ...
            // InternalTSE.g:1582:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1584:10: ( ( '0' .. '9' )+ )
            // InternalTSE.g:1584:12: ( '0' .. '9' )+
            {
            // InternalTSE.g:1584:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1586:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalTSE.g:1586:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalTSE.g:1586:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalTSE.g:1586:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalTSE.g:1586:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalTSE.g:1586:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalTSE.g:1586:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1588:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalTSE.g:1588:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalTSE.g:1588:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1590:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalTSE.g:1590:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalTSE.g:1590:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1592:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalTSE.g:1592:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalTSE.g:1592:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTSE.g:1594:16: ( . )
            // InternalTSE.g:1594:18: .
            {
            matchAny(); 
    ...
    class DFA2 extends DFA {
        ...
        public String getDescription() {
            return "1578:14: ( 'WHITE' | 'BLACK' | 'BLUE' | 'CYAN' | 'DARK_GRAY' | 'GRAY' | 'LIGHT_GRAY' | 'GREEN' | 'MAGENTA' | 'ORANGE' | 'PINK' | 'RED' | 'YELLOW' )";
        }
    }
